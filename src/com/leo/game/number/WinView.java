...
public class WinView extends FrameLayout {
	...
	public WinView(Context context, AttributeSet attrs, int defStyle) {
	...
	public WinView(Context context, float scaleW, float scaleH, OnClickListener onClickListener) {
		super(context);
		// TODO Auto-generated constructor stub
		this.scaleW = scaleW;
		this.scaleH = scaleH;
	...
	private void initBack() {
		Bitmap bitmap = CellViewMap.getInstance().getImageFromAssetFile("win.png");
		if (bitmap == null) {
			return;
		}
